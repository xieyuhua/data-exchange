...
type SQLTaskHistory struct {
	...
	SQLContent string `gorm:"type:text;not null;default:''" json:"sql_content"`
	ChangedBy  string `gorm:"default:''" json:"changed_by"`              // 触发变更的用户名
	Remark     string `gorm:"default:''" json:"remark"`                  // 备注（如“编辑保存”“恢复前快照”）
