<template>
  <div id="app-root">
    <aside class="sidebar">
      ...
      <nav class="nav">
        <router-link v-for="r in nav" :key="r.path" :to="r.path" class="nav-item" active-class="active">
    ...
    <main class="main">
      <header class="topbar">
        ...
        <div class="topbar-right"><span class="clock">{{ now }}</span></div>
      </header>
...
export default {
  ...
  mounted() { this.tick(); setInterval(() => this.tick(), 1000) },
